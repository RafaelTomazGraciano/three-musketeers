...
@.str.puts.bc2e12a3 = private unnamed_addr constant [38 x i8] c"Three Musketeers compiler is working!\00"
define i32 @main() {
entry:
  %1 = alloca i8*, align 1
  ...
  %123 = getelementptr inbounds [38 x i8], [38 x i8]* @.str.puts.bc2e12a3, i32 0, i32 0
